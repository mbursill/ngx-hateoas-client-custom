...
class LibConfig {
    static setConfig(hateoasConfiguration) {
        LibConfig.config = Object.assign(Object.assign({}, LibConfig.DEFAULT_CONFIG), hateoasConfiguration);
    }
}
...
class UrlUtils {
    ...
    static fillTemplateParams(url, options) {
        ValidationUtils.validateInputParams({ url });
        UrlUtils.checkDuplicateParams(options);
        const paramsWithoutSortParam = Object.assign(Object.assign(Object.assign(Object.assign({}, options), options === null || options === void 0 ? void 0 : options.params), options === null || options === void 0 ? void 0 : options.pageParams), { 
...
class BaseResource extends AbstractResource {
    ...
    getRelatedPage(relationName, options) {
        ...
        const relationLink = this.getRelationLink(relationName);
        const optionsToRequest = relationLink.templated
            ? Object.assign(Object.assign({}, options), { params: undefined, pageParams: undefined, sort: undefined }) : options;
...
class NgxHateoasClientConfigurationService {
    ...
    configure(config) {
        var _a;
        ValidationUtils.validateInputParams({ config, baseApi: (_a = config === null || config === void 0 ? void 0 : config.http) === null || _a === void 0 ? void 0 : _a.rootUrl });
